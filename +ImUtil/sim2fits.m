...
FITS.write_old(Sim.(InPar.ImageField),sprintf('%s%s',InPar.OutDir,OutImageName),Header,InPar.DataType);

%FITS.write(Sim.(InPar.ImageField),sprintf('%s%s',InPar.OutDir,OutImageName),'Header',Header,'DataType',InPar.DataType);
%sprintf('%s%s',InPar.OutDir,OutImageName)
%'a'    