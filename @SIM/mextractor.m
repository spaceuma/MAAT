...
%                            'PEAK_GRADBACK',...                           'AZ','ALT','AIRMASS','PARANG',...
%                            'FLAGS','ELLIPTICITY',...
...
%                        
DefV.ColCell            = {'XWIN_IMAGE','YWIN_IMAGE','XPEAK_IMAGE','YPEAK_IMAGE',...
                           'X2WIN_IMAGE','Y2WIN_IMAGE','XYWIN_IMAGE','PEAKF_VAL',...
    ...
    while Icol<Ncol
        ...
        switch (ColCell{Icol})
            ...
            case 'SN_PSF'
                ...
                Cat(Isim).(CatField)(:,Icol) = PsfPhot.(CatField)(:,PsfPhotCol.Flux)./PsfPhot.(CatField)(:,PsfPhotCol.BackErr);
